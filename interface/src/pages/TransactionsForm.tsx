        ...
        <Card>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4 flex flex-col gap-2">
              <label htmlFor={formId} className="mb-2 font-semibold">
                Tipo de Transação
              </label>
            ...
            <div className="flex gap-4 items-center justify-end">
              ...
              >
                {loading ? (
                  <div
                    className="w-4 h-4 mx-auto ml-4 border-4 border-gray-700 border-t-transparent rounded-full animate-spin"
                    role="status"
                  >
