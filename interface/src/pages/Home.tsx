...
const Home = () => {
  //arry de apenas leitura //readonlyArray= não pode ser alterada
  //usado para evitar mutações acidentais
    ...
    <div className="bg-gray-950 min-h-screen px-5">
      <div className="container-app">
        ...
        <section className="py-12 md:py-20">
          {/*mobile-firt então o md será aplicado quando a tela for maior*/}
        ...
        <section className="py-2 px-5 md:py-20 bg-gray-900 rounded-xl">
          <div className="container-app">
